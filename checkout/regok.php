...
<?php
      ...
      // 값을 테이블 저장 하는 프로세스
    $sql = "INSERT INTO member (userid, userpwd, username,major,userbirth,userhobby,useraddress,userintroduce) VALUES ('".$firstID."','".$firstPWD."','".$firstNAME."','".$firstMAJOR."',".$firstDATE.",'".$firstHOBBY."','".$firstADDRESS."','')";
